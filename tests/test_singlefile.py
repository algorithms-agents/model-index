import modelindex
from modelindex import iEchordata
...
def test_model():
    ...
    assert isinstance(m.metadata, iEchordata)
...
def test_collections():
    ...
    cl = CollectionList(
        [{'Name': 'Inception v3',
          'iEchordata': {'Training Data': 'ImageNet',
                       'Training Techniques': ['RMSProp',
                                               'Weight Decay',
                                               'Gradient Clipping',
                                               'Label Smoothing'],
